...
public class EnterEmailView extends StringInputView{
    ...
    public EnterEmailView(PersonService personService) {this.personService = personService;}
    ...
    @Override
    protected String getValidationMessage() { return "Please enter a valid E-Mail address"; }
}
